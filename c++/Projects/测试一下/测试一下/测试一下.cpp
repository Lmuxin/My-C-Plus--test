...
public:
	...
	Student();//无参构造函数
    Student(char s[]);//带一个参数构造函数
	Student(char s[], int sy); //带两个參数构造函数
...
int main()
{
	...
	Student zhangsan("张三");//不能定义为 Student zhangsan,系统会给出zhangsan重定义错误..调用带一个参数的构造函数
